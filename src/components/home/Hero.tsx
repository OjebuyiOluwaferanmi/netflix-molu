        ...
        >
            ...
            <div className="relative z-10 flex h-full flex-col items-center pt-48 ">
                ...
                <div className="flex flex-col items-center justify-center text-center text-white px-4 sm:px-6 md:px-12 lg:px-44 max-w-5xl mx-auto">
                    <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-6xl font-bold mb-2  sm:mb-7 md:mb-3 lg:mb-7">
                        Unlimited movies, TV shows, and more
                    </h1>
                    <p className="text-sm sm:text-xl md:text-2xl lg:text-xl font-semibold mb-2  sm:mb-7 md:mb-3 lg:mb-7">
                        Starts at ₦2,500. Cancel anytime.
                    </p>
                    <p className="text-sm sm:text-xl md:text-2xl lg:text-base  mb-5">
